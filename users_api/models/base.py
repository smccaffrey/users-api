...
from users_api.db.compilers.dates import utcnow
from users_api.db.type_utils.dt import TZDateTime
from users_api.db.type_utils.uuid import GUID
...
class Base(db.DeclarativeBase, UsersSQLAlchemyMixin):
    # pylint: disable=E1101,E0213,R0201
    __abstract__ = True
