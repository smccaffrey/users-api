...
from users_api.schemas.posts import CreatePostRequest, DeletePostResponse, UpdatePostRequest
...
class PostsManager(BaseManager[PostsORM]):
    ...
    def get_all_posts(self, db_session: Session):
        return (
            ...
            .options(joinedload(self.model.users))  # Eager load the related users, solves N+1 problem
            .all()
        )
